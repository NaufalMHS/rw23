...
class TentangController extends Controller
{
    ...
    public function strategi_edit(Request $request) {
        $validated = $request->validate([
            'strategi' => 'required'
        ]);
        ...
        if ($query == true) {
            return redirect('/admin-area/informasi-umum')->with('success', 'Data strategi berhasil diubah.');
        } else {
            return redirect('/admin-area/informasi-umum')->with('error', 'Terdapat kesalahan dalam mengedit data strategi.');
        }
    }
}
