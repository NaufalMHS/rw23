                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label">Visi</label>
                                <textarea name="visi" id="summernote">{!! html_entity_decode($about[0] -> visi) !!}</textarea>
                                @error('visi')
                                <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                    {{ $message }}
                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label">Misi</label>
                                <textarea name="misi" id="summernote">{!! html_entity_decode($about[0] -> misi) !!}</textarea>
                                @error('misi')
                                <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                    {{ $message }}
                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label">Tujuan</label>
                                <textarea name="tujuan" id="summernote">{!! html_entity_decode($about[0] -> tujuan) !!}</textarea>
                                @error('tujuan')
                                <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                    {{ $message }}
                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label">Sasaran</label>
                                <textarea name="sasaran" id="summernote">{!! html_entity_decode($about[0] -> sasaran) !!}</textarea>
                                @error('sasaran')
                                <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="strategi" id="summernote">{!! html_entity_decode($about[0] -> strategi) !!}</textarea>
                                @error('strategi')
                                <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                    {{ $message }}
                                </div>
