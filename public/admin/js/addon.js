...
$(document).ready(function () {
    ...
    var count1 = document.getElementsByTagName('textarea');
    console.log(count1.length);

    if (count1.length != 0) {
        for (let i = 1; i <= count1.length; i++) {
            var new_select = 'summernote-' + i;
            document.getElementById('summernote').id = new_select;
